...
namespace MilliyMock.DataAccess.Migrations
{
    ...
    [Migration("20260616095314_BotUserTgUserIdIsUnique")]
    partial class BotUserTgUserIdIsUnique
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MilliyMock.Domain.Entities.TransactionHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MilliyMock.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2026, 6, 16, 14, 53, 14, 168, DateTimeKind.Utc).AddTicks(5600),
                            CreatedBy = 1L,
                            Email = "ysharpist@gmail.com",
                            EmailConfirmed = false,
                            FirstName = "Abdurrohman",
                            IsDeleted = false,
                            PasswordHash = "$2a$11$lgpsTL1/cUMroVrE0caNp.quuPbM3g/bRMaK/tqZVQVmtLW.3fA0G",
                            Role = 1
                        });
                });
            ...
            modelBuilder.Entity("MilliyMock.Domain.Entities.UserBalance", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MilliyMock.Domain.Entities.QuestionExplanation", b =>
                {
                    b.HasOne("MilliyMock.Domain.Entities.QuestionGroup", "QuestionGroup")
                        .WithOne("QuestionExplanation")
                        .HasForeignKey("MilliyMock.Domain.Entities.QuestionExplanation", "QuestionGroupId");

                    b.HasOne("MilliyMock.Domain.Entities.Question", "Question")
                        .WithOne("QuestionExplanation")
                        .HasForeignKey("MilliyMock.Domain.Entities.QuestionExplanation", "QuestionId");
            ...
            modelBuilder.Entity("MilliyMock.Domain.Entities.UserTestAttempt", b =>
                {
                    b.HasOne("MilliyMock.Domain.Entities.TempUser", "TempUser")
                        .WithMany()
